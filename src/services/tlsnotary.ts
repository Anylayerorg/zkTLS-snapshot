...
import { getNotaryConfig, validateNotaryConfig, type NotaryConfig } from '../config/notary';
...
export class TLSNotaryService {
  ...
  private async simulateTLSProof(
    ...
    const snarkProof = {
      pi_a: ['0', '0', '1'] as [string, string, string],
      pi_b: [['0', '0'], ['0', '0'], ['1', '0']] as [[string, string], [string, string], [string, string]],
      pi_c: ['0', '0', '1'] as [string, string, string],
      protocol: 'groth16',
      curve: 'bn128',
    };
